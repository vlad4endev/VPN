...
export const AdminPanelPropTypes = {
  ...
  // Состояние вкладок
  adminTab: PropTypes.oneOf(['dashboard', 'users', 'tickets', 'notifications', 'settings', 'tariffs', 'payments', 'reviews', 'promocodes', 'n8n', 'telegram', 'ai', 'seo', 'analytics-funnel', 'errors']).isRequired,
  ...
  onHandleTariffSubscriptionLinkChange: PropTypes.func,
