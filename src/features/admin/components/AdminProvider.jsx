...
function buildContextValue(adminHandlers, adminTab, setAdminTab) {
  ...
  return {
    ...
    createUser: ensureFunction(adminHandlers.createUser, 'createUser'),
    fetchNocoDBPreview: ensureFunction(adminHandlers.fetchNocoDBPreview, 'fetchNocoDBPreview'),
    importFromNocoDB: ensureFunction(adminHandlers.importFromNocoDB, 'importFromNocoDB'),
    getSavedNocoDBImportConfig: ensureFunction(adminHandlers.getSavedNocoDBImportConfig, 'getSavedNocoDBImportConfig'),
    saveNocoDBImportConfig: ensureFunction(adminHandlers.saveNocoDBImportConfig, 'saveNocoDBImportConfig'),
    ...
    handleAddLinkedTariff: ensureFunction(adminHandlers.handleAddLinkedTariff, 'handleAddLinkedTariff'),
    handleRemoveLinkedTariff: ensureFunction(adminHandlers.handleRemoveLinkedTariff, 'handleRemoveLinkedTariff'),
    handleUpdateLinkedTariffConfig: ensureFunction(adminHandlers.handleUpdateLinkedTariffConfig, 'handleUpdateLinkedTariffConfig'),
    handleDeduplicateTariffs: ensureFunction(adminHandlers.handleDeduplicateTariffs, 'handleDeduplicateTariffs'),
...
const FALLBACK_CONTEXT = {
  ...
  createUser: ensureFunction(null, 'createUser', noopAsync),
  fetchNocoDBPreview: ensureFunction(null, 'fetchNocoDBPreview', noopAsync),
  importFromNocoDB: ensureFunction(null, 'importFromNocoDB', noopAsync),
  getSavedNocoDBImportConfig: ensureFunction(null, 'getSavedNocoDBImportConfig', noopAsync),
  saveNocoDBImportConfig: ensureFunction(null, 'saveNocoDBImportConfig', noopAsync),
  setEditingUser: () => {},
  editingUser: null,
