...
export default function PaymentResultPage({ success, onGoToDashboard }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen min-h-[100dvh] flex-1 flex flex-col items-center justify-center p-4 bg-slate-950 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-blue-900/10 via-slate-950 to-slate-950 overflow-x-hidden overflow-y-auto">
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] flex-1 flex flex-col bg-slate-950 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-blue-900/10 via-slate-950 to-slate-950 overflow-x-hidden overflow-y-auto">
